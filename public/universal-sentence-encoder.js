...
use.load().then(model => {
  ...
  const sentences = [
    ...
    // "They say that Jupiter punished him so, because he was such a lazy stay-at-home that he would not go to Jupiters wedding, even when especially invited.",
    ...
    // "Hurrying to the tree where the Cock was roosting, he said very politely: A hearty welcome to our woods, honored sir.",
    ...
    // "Wolf!, As he expected, the Villagers who heard the cry dropped their work and ran in great excitement to the pasture.",
    ...
    // "In terror the Boy ran toward the village shouting Wolf!",
    // "Wolf!, But though the Villagers heard the cry, they did not run to help him as they had before.",
    ...
    // "Just then they heard a shout of Stop, thief!",
    // "and looking around, saw a mob of people armed with clubs coming down the road.",
    ...
    // "I'll show him who is fit to be king, he or I. Just then an immense shadow blotted him out entirely, and the next instant a Lion struck him down with a single blow.",
    ...
    // "I am of just as much importance, and But just then the royal Cat spied him, and the next instant, the Rat knew he was not quite so important as an Elephant.",
    ...
    // "On the way home the Ass, remembering what had happened at the ford, purposely let himself fall into the water, and again got rid of most of his burden.",
    ...
    // "That leap was so great, he said, that no other man could leap anywhere near the distance.",
    // "A great many persons in Rhodes had seen him do it and would prove that what he told was true.",
    // "No need of witnesses, said one of the hearers. Suppose this city is Rhodes.",
    ...
    // "I will talk to him, he said, So the Fox walked boldly up to the Lion.",
    ...
    // "You deserve to be punished severely for your rashness!, But, your highness, replied the trembling Lamb, do not be angry!",
    ...
    // "But no matter who it was, I do not intend to be talked out of my breakfast.",
    ...
    // "Did you buy it, or did the Shepherd make you a gift of it?, Pray tell me, how did you get it?",
    ...
    // "In despair the Mice called a council, and there it was decided that the Mouse army was always beaten because it had no leaders.",
    ...
    // "Soon the Mouse line gave way before the attack and the whole army fled for cover.",
    // "The privates easily slipped into their holes, but the Mouse leaders could not squeeze through the narrow openings because of their head-dresses.",
    // "Not one escaped the teeth of the hungry Weasels.",
    ...
    // "Look at my ribs. I am nothing but skin and bone. But let me tell you something in private.",
    ...
    // "Then is the time to eat me. The Wolf could not help thinking how nice it would be to have a fine fat Dog to eat instead of the scrawny object before him.",
    ...
    // "Sir, said the Dog, with a grin, I shall be delighted to have you eat me.",
    ...
    // "The Ass was to go into the cave and drive the Goats out, while the Lion would stand at the entrance to strike them down.",
    ...
    // "Now the black Jackdaw was not a very handsome bird, nor very refined in manner.",
    ...
    // "The Wolf saw the wisdom of the advice, for he wanted to enjoy his meal without any danger of choking.",
    // "So the Ass lifted up his foot and the Wolf began to search very closely and carefully for the thorn.",
    // "Just then the Ass kicked out with all his might, tumbling the Wolf a dozen paces away.",
    // "And while the Wolf was getting very slowly and painfully to his feet, the Ass galloped away in safety.",
    ...
    // "The Rabbit was quite angry for a Rabbit, and requested the Weasel to move out.",
    // "But the Weasel was perfectly content. He was settled down for good.",
    ...
    // "No small fry for me, he said.",
    // "Such scanty fare is not fit for a Heron.",
    ...
    // "They must have heard the good news and But the Fox did not wait to hear more.",
    // "Off he started on a run. Wait, cried the Cock.",
    ...
    // "said one. He cannot eat the hay and yet he will not let us eat it who are so hungry for it!",
    ...
    // "That is a very dangerous place for you, he called out, pretending to be very anxious about the Goat's safety.",
    ...
    // "How very, very anxious you are about me, she said, and how generous you are with your grass!",
    ...
    // "It was such a joyful song that his pleasure-loving heart was filled with a wish to sing as they did.",
    // "What is it?, he asked very respectfully, that has given you such beautiful voices?",
    // "Is there any special food you eat, or is it some divine nectar that makes you sing so wonderfully?",
    // "Yes, said the Grasshoppers, who were very fond of a joke; it is the dew we drink!",
    // "Try some and see. So thereafter the Ass would eat nothing and drink nothing but dew.",
    // "Naturally, the poor foolish Ass soon died.",
    // "A Mule had had a long rest and much good feeding.",
    ...
    // "I can feel that distinctly. Next day he was put into harness again and that evening he was very downhearted indeed.",
    ...
    // "You should have seen him, On top of his head and in front of his neck hung pieces of raw red meat.",
    ...
    // "As for the Cat, he eats us. So be thankful, my child, that you escaped with your life, and, as long as you live, never judge people by their looks.",
    ...
    // "At first the Cranes flew away in great terror.",
    // "But they soon began to see that none of them ever got hurt.",
    // "They did not even hear the noise of stones whizzing through the air, and as for words, they would kill nobody.",
    // "At last they paid no attention whatever to the Farmer.",
    // "The Farmer saw that he would have to take other measures.",
    // "He wanted to save at least some of his grain.",
    // "So he loaded his sling with stones and killed several of the Cranes.",
    // "This had the effect the Farmer wanted, for from that day the Cranes visited his field no more.",
    ...
    // "No hidden gold did they find; but at harvest time when they had settled their accounts and had pocketed a rich profit far greater than that of any of their neighbors",
    // "They understood that the treasure their father had told them about was the wealth of a bountiful crop, and that in their industry had they found the treasure.",
    // "Two Pots, one of brass and the other of clay, stood together on the hearthstone.",
    // "One day the Brass Pot proposed to the Earthen Pot that they go out into the world together.",
    // "But the Earthen Pot excused himself, saying that it would be wiser for him to stay in the corner by the fire.",
    // "It would take so little to break me, he said, You know how fragile I am.",
    ...
    // "If we should happen to meet anything hard I will step between and save you.",
    ...
    // "Indeed he became about three times as big around the middle as he was when he went in.",
    ...
    // "You've been stuffing. That's what you get.",
    ...
    // "The Shepherd wanted to make the Wild Goats part of his flock; so he fed them well.",
    ...
    // "A few days later a change in weather brought a severe frost",
    // "And the poor swallow and that foolish young man in his light tunic, and with his arms and knees bare, could scarcely keep life in their shivering bodies.",
    // "A Cat was growing very thin. As you have guessed, he did not get enough to eat.",
    // "One day he heard that some Birds in the neighborhood were ailing and needed a doctor.",
    // "So he put on a pair of spectacles, and with a leather box in his hand, knocked at the door of the Bird's home.",
    // "The Birds peeped out, and Dr. Cat, with much solicitude, asked how they were.",
    // "He would be very happy to give them some medicine.",
    // "Tweet, tweet, laughed the Birds.",
    ...
    // "His eyes were fixed on the stars. He thought he saw there that the end of the world was at hand, when all at once, down he went into a hole full of mud and water.",
    ...
    // "As they pulled him out of the mud, one of them said: You pretend to read the future in the stars, and yet you fail to see what is at your feet!",
    // "This may teach you to pay more attention to what is right in front of you, and let the future take care of itself.",
    ...
    // "The Lion had little hope of eating them, for he was no match for three strong Bullocks with their sharp horns and hoofs.",
    // "But he could not keep away from that field, for it is hard to resist watching a good meal, even when there is little chance of getting it.",
    // "Then one day the Bullocks had a quarrel, and when the hungry Lion came to look at them and lick his chops as he was accustomed to do, he found them in separate corners of the field",
    ...
    // "When the Frog saw the Mouse, he swam to the bank and croaked: Won't you pay me a visit?",
    ...
    // "And they say that ever after, while the Eagle's eggs lie in the nest in spring, the Beetle still sleeps in the ground.For so Jupiter commanded.",
    ...
    // "But Master Fox very wisely stayed outside, thanking the Lion very kindly for the invitation.",
    ...
    // "There was once an Ass whose Master also owned a Lap Dog.",
    // "This Dog was a favorite and received many a pat and kind word from his Master, as well as choice bits from his plate.",
    // "Every day the Dog would run to meet the Master, frisking playfully about and leaping up to lick his hands and face.",
    // "All this the Ass saw with much discontent.",
    // "Though he was well fed, he had much work to do; besides, the Master hardly ever took any notice of him.",
    // "Now the jealous Ass got it into his silly head that all he had to do to win his Master's favor was to act like the Dog.",
    // "So one day he left his stable and clattered eagerly into the house.",
    ...
    // "But his weight upset the chair, and Ass and man rolled over together in the pile of broken dishes from the table.",
    // "The Master was much alarmed at the strange behavior of the Ass, and calling for help, soon attracted the attention of the servants.",
    // "When they saw the danger the Master was in from the clumsy beast, they set upon the Ass and drove him with kicks and blows back to the stable.",
    // "There they left him to mourn the foolishness that had brought him nothing but a sound beating.",
    ...
    // "Why did you put it there?, Why did you not keep it in the house where you could easily get it when you had to buy things?",
    ...
    // "He was really nothing but skin and bones, and it made him very downhearted to think of it.",
    // "One night this Wolf happened to fall in with a fine fat House Dog who had wandered a little too far from home.",
    // "The Wolf would gladly have eaten him then and there, but the House Dog looked strong enough to leave his marks should he try it.",
    ...
    // "Leave the woods; there you live miserably.",
    // "Why, you have to fight hard for every bite you get.",
    // "Follow my example and you will get along beautifully.",
    // "What must I do? asked the Wolf",
    // "Hardly anything, answered the House Dog. Chase people who carry canes, bark at beggars, and fawn on the people of the house.",
    ...
    // "What!",
    // "nothing!",
    // "Oh, just a trifle!, But please tell me.",
    ...
    // "A Bat blundered into the nest of a Weasel, who ran up to catch and eat him.",
    // "The Bat begged for his life, but the Weasel would not listen.",
    ...
    // "What, cried the Bat, I, a Bird!",
    // "Why, all Birds have feathers!",
    // "I am nothing but a Mouse.",
    // "'Down with all Cats,' is my motto!",
    ...
    // "The Fox heard the news and hurried to see the Toad.",
    // "He looked the Toad over very carefully. Mr. Toad, he said, I've been told that you cure anything!",
    ...
    // "I saw you kiss Miss Geranium, and you fluttered around Miss Mignonette until Honey Bee chased you away.",
    // "I wish he had stung you!",
    // "Constancy! laughed the Butterfly. I had no sooner left you than I saw Zephyr kissing you.",
    ...
    // "Just then, close by, they heard a hunter's horn and the yelping of a pack of hounds.",
    ...
    // "The sly Fox soon found a bright patch of moonlight, where the Pheasants could see him clearly; there he raised himself up on his hind legs, and began a wild dance.",
    ...
    // "Why, of course, replied the Kite.",
    ...
    // "When all the animals were gathered together he arose and said: Dear friends, I believe the gods have sent this plague upon us as a punishment for our sins.",
    ...
    // "I had no right to do it, I admit- A great uproar among the beasts interrupted him.",
    ...
    // "To find the thief I offered to sacrifice a fat Calf.",
    ...
    // "The argument grew very pointed, and it looked as if the affair could not be settled without a battle, when at last, with much good sense, they agreed to let a judge decide the matter.",
    ...
    // "This wheat is now ready for reaping, said the Farmer.",
    ...
    // "When an old Rat, who had had much experience with Cats and traps, and had even lost a part of his tail to pay for it, sat up at a safe distance from a hole in the wall where he lived.",
    ...
    // "The Ass did not dislike being carried, but so many people came up to point at him and laugh and shout, that he began to kick and bray, and then, just as they were crossing a bridge, the ropes that held him gave way",
    ...
    // "Laugh if you will, said the Mother Monkey.",
    // "Though Jupiter may not give him the prize, I know that he is the prettiest, the sweetest, the dearest darling in the world.",
    ...
    // "He quickly piled all the game into one great heap.",
    // "From this he took a very small portion for himself, such undesirable bits as the horns and hoofs of a mountain goat, and the end of an ox tail.",
    ...
    // "Approaching the Ass, he said with a laugh: If you had kept your mouth shut you might have frightened me, too.",
